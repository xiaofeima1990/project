...
#            driver.execute_script("QueryAction.GoPage('TAB',"+str(i)+",200)")            
            WebDriverWait(driver,60).until(EC.presence_of_element_located((By.CSS_SELECTOR,"td.pager")))
            if i >10:             
                data_check=driver.find_element_by_xpath("//td/div/table/tbody/tr/td[2]/span[2]").text
            else:
                data_check=driver.find_element_by_xpath("//td/div/table/tbody/tr/td[2]/span").text
