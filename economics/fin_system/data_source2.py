# -*- coding: utf-8 -*-
"""
Created on Sun Jun 18 20:15:59 2017

@author: guoxuan

financial analysis data source session

get stock financial report data and do the dubang analysis 
...
mk=ts.Market()
stock_all_history=mk.MktEqud(secID=','.join(stock_small_list['secID'].values[0:5]),beginDate='20150101',endDate='20170905')
