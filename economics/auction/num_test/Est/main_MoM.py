...
This is used for Moment estimation test
I have two different MLE method. 
1. ancient version, which is my initial estimation method
2. current version, which modify the random draw process
"""
