...
main unit test for data estimation 
...
def GMM_Ineq(Theta0,DataStruct,d_struct):
    Theta={
    "comm_mu":Theta0[0],
...
#    print('# of auctions: '+str(TT) )
    ...
    for arg_data_ele in zip(range(0,TT),DataStruct['bidder_state'],DataStruct['bidder_pos'],DataStruct['price_norm'],DataStruct[pub_col].values.tolist()):
