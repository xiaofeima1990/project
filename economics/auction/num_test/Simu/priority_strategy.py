...
if __name__ == '__main__':
    ...
    with open( PATH + "simu_data_3_uninfo-0.pkl", "rb") as f :
        simu_data_0=pk.load( f)
    # with the informed bidder
    with open( PATH + "simu_data_3_info-0.pkl", "rb") as f :
        simu_data_1=pk.load( f)
    
    list_num0=[80,120,120,100,100,80,70,50,50,44,36,50,50,50]
    list_num1=[80,128,135,100,70,70,115,50,20,44,20,50,50,60]
    
    list_num0_70 = [70,100,120,100,100,100,60,50,50]
    list_num1_70 = [90,120,160,70,40,100,150,50,50]
    list_num0_100= [100,130,130,100,100,65,75,40,35]
    list_num1_100= [60,60,70,130,100,40,150,80,35]
    
#    N_chunk=len(simu_data_0)
    N_chunk=9
    n_start=0
    for i in range(n_start,N_chunk):
        temp_sim_0=simu_data_0[i][1][:list_num0_100[i]]
        sim_0_list=[]
        if i ==n_start:
            sim_0_df=temp_sim_0
        else:
...
#    N_chunk=len(simu_data_1)
    ...
    for i in range(n_start,N_chunk):
        temp_sim_1=simu_data_1[i][1][:list_num1_100[i]]
        sim_1_list=[]
        if i ==n_start:
            sim_1_df=temp_sim_1
        else:
